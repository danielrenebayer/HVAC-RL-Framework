...
def get_argparser():
    ...
    parser.add_argument('--clip_econs_at', type=float, default=0.0, help="If set to a value > 0, it will clip the reward in kWh there")
    ...
    parser.add_argument('--single_setpoint_agent_count', type=str, default="all", choices=["all", "one", "two", "one_but3not5", "one_but2not5"])
